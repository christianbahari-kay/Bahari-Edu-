...
//             <h2 className="profile-name">Kent Ito</h2>
...
//             <p className="detail-value">TCH-27849</p>

//             <p className="detail-label">Email</p>
//             <p className="detail-value">kent.ito@school.edu</p>

//             <p className="detail-label">Phone</p>
//             <p className="detail-value">+6287364892008</p>
...
//             <p className="detail-value">Tokyo, 18-Oct-1988</p>

//             <p className="detail-label">Education Qualification</p>
//             <p className="detail-value">Ph.D. in Biological Scuences, Master's in Physics</p>

//             <p className="detail-label">Years of Experience</p>
//             <p className="detail-value">15 Years</p>

//             <p className="detail-label">Certification & Awards</p>
//             <p className="detail-value">1. Certified Advanced Science Educator (2019)</p>
//             <p className="detail-value">2. "Innovative Teaching Award" - National Science Board (2021)</p>
//           </div>
//         </div>
